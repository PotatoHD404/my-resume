...
% \section{О себе}
% \small{
%   Я Full Stack разработчик с опытом работы в React, Go, Python, \Csh{}. У меня есть опыт в разработке веб-приложений, управлении базами данных и взаимодействии с API. Я постоянно самосовершенствуюсь и изучаю новые технологии и методологии, что помогает улучшать качество моей работы.
% }
%--------------------------------------------
...
\resumeHeadingListStart{}
  ...
  {Tinkoff}{}
    \resumeItemListStart{}
      \resumeItem{Разработал систему обработки данных с использованием Kafka, Flink, Python, Clickhouse, FastAPI. В результате стажировки был полностью написан и запущен в работу сервис, способный обрабатывать 100 тысяч логов в секунду.}
    \resumeItemListEnd{}
...
% \section{Проекты}
%   \resumeHeadingListStart{}
%       \resumeTrioHeading{}{Telegram, Golang, Yandex Cloud, PostgreSQL, SQS}{}
%         \resumeItemListStart{}
%         \resumeItem{Serverless телеграм бот для поиска свободных кабинетов в НИЯУ МИФИ}
%         \resumeItem{Основываясь на данных, регулярно собирающихся парсером с портала \href{https://home.mephi.ru}{home.mephi}, студент может найти свободные кабинеты в заданную дату и время или получить подробную информацию о занятиях в выбранном кабинете}
%         \resumeItem{Основными сложностями были описание разветвленной логики бота и написание сложных оптимизированных SQL запросов}
%         \resumeItemListEnd{}
\section{Пет-проекты}
      ...
      \resumeItemListStart{}
        ...
        \resumeItem{Реализовал парсер для SQL, DSL для программного использования}
