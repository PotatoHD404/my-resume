...
\section{Навыки}
  \resumeHeadingListStart{}
    ...
    \resumeSectionType{Фреймворки}{:}{React.js, ASP.NET, Django}
    ...
    \resumeSectionType{Облака}{:}{Yandex Cloud, AWS}
  ...
  \resumeHeadingListStart{}
    \resumeTrioHeading{\href{https://daily-mephi.ru}{\uline{daily-mephi.ru}}}{Next.js, Typescript, Serverless, Yandex cloud}{\href{https://github.com/MEPhI-Floppas/daily-mephi}{\uline{Source Code}}}
      \resumeItemListStart{}
        ...
        \resumeItem{Основной сложностью было написать парсер SQL и последующую обработку запроса}
      \resumeItemListEnd{}
